    ...
    <div className="w-full mx-auto p-6">
      <div className="flex w-[90%] justify-center">
          ...
          {(() => {
            ...
            return (
              <img
                ...
                onError={(e) => {
                  e.currentTarget.src = DefaultProductImage as unknown as string;
                }}
              />
            );
          })()}
        ...
        <div className="w-1/2 p-4">
          ...
          <p className="text-gray-500 p-3">{product.desc}</p>
          <div>
            $ <span className="font-bold">{product.price}</span>
          </div>
          <p className="font-bold p-3">Call the owner</p>
      ...
      <div className="w-full mt-10">
        <h1 className="font-bold text-2xl mb-4">More Products</h1>
        <ProductProvider>
