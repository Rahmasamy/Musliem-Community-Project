...
export default function ProfileAdvertisments() {
    ...
    const handleEditForm = (service: any) => {
        ...
        setEditData({
            ...
            phone: service.phone,
            extraDetails: {
                openDate: service.extraDetails?.openDate || '',
                closeDate: service.extraDetails?.closeDate || ''
            }
        })
    }
    ...
    const handleBlur = (e: React.FocusEvent) => {
        // Don't save if the user is moving between inputs in the same service
        const relatedTarget = e.relatedTarget as HTMLElement;
        if (relatedTarget && relatedTarget.closest('.advertismentContainer')) {
            return; // User is still within the same service container
        }
        handleSave();
    }
    ...
    return (
        <div className="w-full mx-auto p-6">
            {/* Title */}
            <h2 className="text-gray-400 text-sm mb-4 font-bold">Your Advertisments</h2>
            ...
            <div className="flex justify-between items-center ">
                <div className="flex items-center p-2">
                    <Link to='/halal-business-dirctory/advertise'>
            ...
            {services.map((service) => (
                <div className="advertismentContainer" key={service._id}>
                    <div className="flex flex-col items-start gap-3 p-3">
                        ...
                        {editId === service._id ? (
                            <input
                                ...
                                onBlur={handleBlur}
                                className="font-bold text-xl mb-2 border border-gray-300 rounded px-2 py-1"
                                autoFocus
                            />
                        ) : (
                            ...
                            <div className="flex items-center gap-2">
                                <span>
                                    <svg width="24" height="30" viewBox="0 0 24 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M4.73331 6.25158C6.53411 4.4868 8.95861 3.50399 11.48 3.51672C14.0013 3.52946 16.4157 4.53671 18.1986 6.31959C19.9815 8.10247 20.9888 10.5169 21.0015 13.0383C21.0142 15.5596 20.0314 17.9841 18.2666 19.7849L13.2086 24.843C12.7554 25.2961 12.1408 25.5506 11.5 25.5506C10.8592 25.5506 10.2446 25.2961 9.79139 24.843L4.73331 19.7849C2.9388 17.9902 1.93066 15.5562 1.93066 13.0182C1.93066 10.4803 2.9388 8.04628 4.73331 6.25158Z" stroke="#1F1F1F" strokeWidth="1.5" strokeLinejoin="round" />
                                        <path d="M11.5 16.6431C13.502 16.6431 15.125 15.0201 15.125 13.0181C15.125 11.016 13.502 9.39307 11.5 9.39307C9.49797 9.39307 7.875 11.016 7.875 13.0181C7.875 15.0201 9.49797 16.6431 11.5 16.6431Z" stroke="#1F1F1F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </span>
                                {editId === service._id ? (
                                    <input
                            ...
                            <div className="flex items-center gap-2">
                                <span>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M14.9929 17L11 13.2733V7H12.4286V12.72L16 16.06L14.9929 17Z" fill="#1F1F1F" />
                                    </svg>
                                </span>
                                {editId === service._id ? (
                                    <div className="flex items-center gap-1">
                                        ...
                                        <input
                                            type="text"
                                            value={editData.extraDetails.openDate}
                                        ...
                                        <input
                                            type="text"
                                            value={editData.extraDetails.closeDate}
                                    ...
                                    <span>Open Daily: {service.extraDetails?.openDate || ''} - {service.extraDetails?.closeDate || ''}</span>
                                )}
                            </div>
                    ...
                    <div className="mt-4 flex justify-center items-center">
                        <img src={`${service?.image}`} alt="Ad" className="rounded-md w-2/3" />
                    </div>
