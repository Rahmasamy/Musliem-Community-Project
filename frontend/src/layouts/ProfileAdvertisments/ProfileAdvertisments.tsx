...
export default function ProfileAdvertisments() {
    return (
        <div className="w-full mx-auto p-6">
            ...
            <div className="flex justify-between items-center p-3">
                <div className="flex justify-between items-center">
                    <img src={groupperson1} alt=" profile image" className='rounded-full w-24 h-20 object-cover' />
            ...
            <div className="flex justify-between items-center ">
                ...
                <div className="flex flex-col items-start gap-3 p-3">
                    <h1 className='font-bold text-xl mb-2 '>Business Name comes here</h1>
                        ...
                        <p>
                            ...
                            <span>
                                <svg width="24" height="30" viewBox="0 0 24 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M4.73331 6.25158C6.53411 4.4868 8.95861 3.50399 11.48 3.51672C14.0013 3.52946 16.4157 4.53671 18.1986 6.31959C19.9815 8.10247 20.9888 10.5169 21.0015 13.0383C21.0142 15.5596 20.0314 17.9841 18.2666 19.7849L13.2086 24.843C12.7554 25.2961 12.1408 25.5506 11.5 25.5506C10.8592 25.5506 10.2446 25.2961 9.79139 24.843L4.73331 19.7849C2.9388 17.9902 1.93066 15.5562 1.93066 13.0182C1.93066 10.4803 2.9388 8.04628 4.73331 6.25158Z" stroke="#1F1F1F" stroke-width="1.5" stroke-linejoin="round" />
                                    <path d="M11.5 16.6431C13.502 16.6431 15.125 15.0201 15.125 13.0181C15.125 11.016 13.502 9.39307 11.5 9.39307C9.49797 9.39307 7.875 11.016 7.875 13.0181C7.875 15.0201 9.49797 16.6431 11.5 16.6431Z" stroke="#1F1F1F" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
      ...
      <img src={AdvertiseImg} alt="Ad" className="rounded-md w-2/3" />
    </div>
