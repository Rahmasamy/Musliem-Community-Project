...
export default function ProfileSection() {
  ...
  return (
    <div className="w-full mx-auto p-6 ">
      ...
      <div className="flex-col lg:flex-row justify-between items-center p-3">
        <div className="flex items-center">
          <div className="relative w-24 h-24">
            <img
              src={`${
                profile?.photo ??
                "https://tse3.mm.bing.net/th/id/OIP._aC-G3lqi8LHgTetCe6tCgHaHa?rs=1&pid=ImgDetMain&o=7&rm=3"
              }`}
              alt="profile image"
        ...
        <div className="logout flex items-center cursor-pointer">
          <button
            className="flex m-2 gap-2 text-red-400 rounded-xl p-2 hover:bg-slate-50 hover:text-teal-600 hover:border-teal-600 border-red-400 border-2"
      ...
      {/* Skills Selection */}
      <div className="flex flex-col lg:flex-row gap-4 mb-6 p-3">
      ...
      {/* <div className=" flex flex-col lg:flex-row gap-4 mb-6 p-3">
        ...
        ${
          role === r
            ? "bg-gradient-to-t from-[#00787B] to-[#003F41] text-white shadow-lg cursor-default"
            : "border-gray-300 bg-white text-gray-800 opacity-60 cursor-not-allowed"
        }`}
          >
