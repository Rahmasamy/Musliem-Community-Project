...
export default function ProfileSection() {
    ...
    const [Role, setRole] = useState("Indvidual");
        ...
        <div className="w-full mx-auto p-6">
            ...
            <div className="flex justify-between items-center p-3">
                ...
                <div className="logout flex items-center cursor-pointer">
                    <button className='flex gap-2 text-red-400 rounded-xl p-2 hover:bg-slate-50 hover:text-white border-red-400 border-2 '>
            ...
            <div className="flex gap-4 mb-6 p-3">
                <button
                    onClick={() => setSkill("skill0")}
                    className={`border rounded-2xl p-4 text-center transition duration-300 ${Skill === "skill0"
                        ? "bg-gradient-to-t from-[#00787B] to-[#003F41] text-white shadow-lg"
                        : "border-gray-300 bg-white text-gray-800 hover:bg-gray-100"
                        }`}
                >
                    <p className="font-medium">Skill0</p>

                </button>

                <button
                    onClick={() => setSkill("skill1")}
                    className={`border rounded-lg p-4 text-center transition duration-300 ${Skill === "skill1"
                        ? "bg-gradient-to-t from-[#00787B] to-[#003F41] text-white shadow-lg"
                        : "border-gray-300 bg-white text-gray-800 hover:bg-gray-100"
                        }`}
                >
                    <p className="font-medium">Skill1</p>

                </button>

                <button
                    onClick={() => setSkill("skill2")}
                    className={`border rounded-lg p-4 text-center transition duration-300 ${Skill === "skill2"
                        ? "bg-gradient-to-t from-[#00787B] to-[#003F41] text-white shadow-lg"
                        : "border-gray-300 bg-white text-gray-800 hover:bg-gray-100"
                        }`}
                >
                    <p className="font-medium">skill2</p>
            ...
            <div className="flex gap-4 mb-6 p-3">
                ...
                <button
                    onClick={() => setRole("Non Profit Organization")}
                    className={`border rounded-lg p-4 text-center transition duration-300 ${Role === "Non Profit Organization"
                        ? "bg-gradient-to-t from-[#00787B] to-[#003F41] text-white shadow-lg"
                        : "border-gray-300 bg-white text-gray-800 hover:bg-gray-100"
                        }`}
                >
                ...
                <button
                    ...
                    className={`border rounded-lg p-4 text-center transition duration-300 ${Role === "Business Owner"
                        ? "bg-gradient-to-t from-[#00787B] to-[#003F41] text-white shadow-lg"
                        : "border-gray-300 bg-white text-gray-800 hover:bg-gray-100"
                        }`}
                >
