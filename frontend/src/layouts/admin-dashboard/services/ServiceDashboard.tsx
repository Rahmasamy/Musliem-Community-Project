...
const {
  ...
  if (error) return <p className="text-center text-red-500 my-6 sm:my-10 text-base sm:text-lg">
  ...
  return (
    <div className="space-y-4 sm:space-y-6 lg:space-y-8">
      {services && services.length > 0 ? (
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b pb-3 sm:pb-4 mb-3 sm:mb-4 gap-3 sm:gap-0">
              <div className="flex-1 w-full">
                ...
                <div className="flex items-center gap-2 sm:gap-3 mt-2 sm:mt-3">
                  <img
                    src={service?.user?.photo || "https://via.placeholder.com/80"}
                    alt="creator"
              ...
              <div className="flex gap-2 sm:gap-3 flex-shrink-0">
                <button
                  ...
                  onClick={() => handleApproval(service._id, "rejected")}
                ...
                <button
                  ...
                  onClick={() => handleApproval(service._id, "approved")}
                  disabled={approvalMutation.isPending}
                >
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                ...
                <div>
                  <h3 className="font-semibold text-base sm:text-lg text-gray-800 mb-2 sm:mb-3">{service?.name}</h3>
                  <img
                    src={
                      service?.image ||
                ...
                <div className="text-gray-600 leading-relaxed space-y-3 sm:space-y-4">
                  ...
                  <div className="pt-3 sm:pt-4 border-t mt-3 sm:mt-4">
                    ...
                    <p className="text-xs sm:text-sm">
                      ...
                      <span className="capitalize">{service?.paymentStatus}</span>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <p className="text-center text-gray-500 text-base sm:text-lg">No Services found.</p>
      )}
    </div>
  )
}
