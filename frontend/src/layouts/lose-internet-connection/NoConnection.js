...
const NoConnection = () => {
    ...
    if (!showNoConnection)
        return null;
    return (_jsxs("div", { className: "no-connection h-screen flex flex-col gap-2 justify-center items-center bg-gray-100 text-center", children: [_jsx("img", { src: NConnectionImg, alt: "No connection" }), _jsx("p", { className: "text-4xl font-bold ", children: "No connection" }), _jsx("p", { className: "mt-2 ", children: "Oops! It seems you're currently offline." }), _jsx("button", { onClick: () => window.location.reload(), className: "mt-4 px-4 py-2  text-white  go-home ", children: "Refresh" })] }));
};
