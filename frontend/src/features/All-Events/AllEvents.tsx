  ...
  return (
    <div className="container">
      ...
      <div className="w-full mx-auto px-4 py-6 space-y-6 ">
        <div className="bg-orange-100 text-gray-800 font-semibold px-4 py-2 rounded">
          Oct 2025
        </div>

        <div className="border-b pb-4">
          <div className="text-sm text-gray-600">15/10/2025</div>
          <div className="text-sm text-gray-600">12:00 pm</div>
          <h3 className="font-semibold mt-1">Event Name Goes here</h3>
          <a href="#" className="text-blue-600 font-medium text-sm">
            In-Person
          </a>
          <p className="text-gray-500 text-sm mt-1">
            Lorem ipsum dolor sit amet consectetur. Sed massa pretium sed
            scelerisque elementum congue interdum cras. At nisl in quisque erat
            ut.
          </p>
        </div>
        ...
        <div className="flex justify-center mt-6">
          <button className="bg-teal-600 hover:bg-teal-700 text-white font-semibold px-6 py-2 rounded-full text-sm">
            Load More
          </button>
        </div>
      </div>
