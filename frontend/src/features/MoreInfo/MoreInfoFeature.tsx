...
export default function MoreInfoFeature() {
    ...
    const handleCreate = async () => {
        ...
        if (registerState.businessPhoto) formData.append("businessPhoto", registerState.businessPhoto);
                    ...
                    <div className="inputFields w-full flex flex-col gap-5 items-start">
                        ...
                        <div className="Bio w-full">
                            ...
                            <textarea
                                ...
                                className={`w-full p-3 rounded-md ${bioField.touched && !bioField.value ? "border-red-500" : ""
                                    }`}
                            >
