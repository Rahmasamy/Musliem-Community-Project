...
const AuthButton:React.FC<ButtonProps> = ({
  ...
  const baseStyles = "py-3 px-2 rounded-md text-white font-meduim transition duration-200 text-sm text-align-center"
  const variants = {
    'primary': 'bg-[#1C7A80] text-white hover:bg-[#004f48] border-none w-8/12',
